...
export const useThemeStore = defineStore(SetupStoreId.Theme, () => {
  ...
  /** Optional Antdv Next theme overrides from preset */
  const antdvThemeOverrides: Ref<App.Theme.AntdvThemeOverride | undefined> = ref(undefined);
  ...
  /**
   * Set Antdv Next theme overrides
   *
   * @param overrides Antdv Next theme overrides or undefined to clear
   */
  function setAntdvThemeOverrides(overrides?: App.Theme.AntdvThemeOverride) {
    antdvThemeOverrides.value = overrides;
  }
