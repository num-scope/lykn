...
declare namespace App {
  ...
  namespace Theme {
    ...
    /** Antdv Next theme overrides that can be specified in preset */
    type AntdvThemeOverride = import('antdv-next').ThemeConfig;
  ...
  namespace Global {
    ...
    /** Form rule */
    type FormRule = import('antdv-next/dist/form/types').Rule;
